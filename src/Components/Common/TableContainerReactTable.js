...
const TableContainer = ({
  ...
  return (
    <Fragment>
      ...
      {isPagination && (
        <Row className="align-items-center g-3 text-center text-sm-start mb-3 ms-4">
          ...
          <div className="col-sm-auto">
            <ul className="pagination pagination-separated pagination-md justify-content-center justify-content-sm-start mb-0">
              ...
              {pageOptions.map((item, key) => {
                // Logic for ellipsized pagination
                if (pageOptions.length > 7) {
                  if (
                    item === 0 || // Always show first page
                    item === pageOptions.length - 1 || // Always show last page
                    Math.abs(pageIndex - item) < 2 // Show 2 pages before and after current page
                  ) {
                    return (
                  ...
                  } else if (key === 1 || key === pageOptions.length - 2) {
                    // Show one ellipsis button if not shown before
                    return (
